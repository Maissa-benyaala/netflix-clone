  ...
  return (
    <div className="App">
      <header className="App-header">
        <Nav addMovie={addMovie} setSearch={setSearch}/>
        <LandingPage />
      </header>
      <div className="App-content">
        <MovieList category="Trending Now" movies={movies} search={search}/>
        <MovieList category="Top Rated" movies={movies} search={search}/>
        <MovieList category="My List" movies={movies} search={search}/>
        <MovieList category="Action Movies" movies={movies} search={search}/>
        <MovieList category="Comedy Movies" movies={movies} search={search}/>
        <MovieList category="Drama Movies" movies={movies} search={search}/>
      </div>
    </div>
  );
}
